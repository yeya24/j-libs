...
function(params) {
  ...
  volumeClaim: {
    ...
    metadata: {
      name: 'pyroscope',
      namespace: prc.config.namespace,
      labels: { 'app.kubernetes.io/name': prc.deployment.metadata.name },
    },
    spec: {
      accessModes: ['ReadWriteOnce'],
      storageClassName: prc.config.storageClassName,
      resources: {
        requests: {
          storage: prc.config.pvcSize,
        },
      },
    },
  },
            ...
            volumes: [
              ...
              },
              {
                ...
                persistentVolumeClaim: {
                  claimName: prc.volumeClaim.metadata.name,
                },
              },
            ],
            nodeSelector: {
