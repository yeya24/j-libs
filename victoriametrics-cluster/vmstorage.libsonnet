...
function(params) {
  ...
  assert !std.objectHas(vm.config.volumeClaimTemplate, 'spec') || std.assertEqual(vm.config.volumeClaimTemplate.spec.accessModes, ['ReadWriteOnce']) : 'vmstorage PVC accessMode can only be ReadWriteOnce',
